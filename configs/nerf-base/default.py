...
train_config = dict(
    ...
    Sty_lrate_rgbnet = 2e-3 ,
    Sty_lrate_k0 = 5e-2 ,
    Sty_lrate_Ori_Model_rgbnet = 5e-2 ,
    ...
    weight_tv_feature= 1e-4, # 1e-4
    pg_scale=[2000, 4000, 6000],
    skip_zero_grad_fields=['feature'],
    deform_weight_tv_k0=1e10,             # weight of total variation loss of color/feature voxel grid
